		...
		<div class="ilmoituslayer">
			...
			<img src="valiviiva.gif" alt="some_text"/>
				...
				<form action = "vaihdasalasana.php" method="post">
					...
					<div class="etu">
					<input type="text" style="width:200px; height:30px;" name="vanhasalasana" />
					</div>
					...
					<div class="suku">
					<input type="text" style="width:200px; height:30px;" name="uusisalasana" />
					</div>
					...
					<div class="etu">
					<input type="text" style="width:200px; height:30px;" name="uusisalasanauud" />
					</div>
